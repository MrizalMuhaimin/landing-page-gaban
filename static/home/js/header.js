...
program_header_btn[0].onclick = function() {
    document.querySelector(".program-gaban").scrollIntoView({behavior: "smooth",block: "center"});
}

berita_header_btn[0].onclick = function() {
    document.querySelector(".title-sponsor").scrollIntoView({behavior: "smooth",block: "center"});
}
